        ...
        <>  
            <div className="justify-between px-64 py-64 max-w-5xl min-h-screen snap-start">
                ...
                <div className="flex gap-x-4 pr-16 py-2">
                    ...
                    <button onClick={scrollToAbout} className="border-blue-500 text-blue-500 border-2 rounded-md shadow-lg hover:shadow-blue-400 hover:text-blue-400 hover:border-blue-400 transition duration-300 text-xl font-bold px-8 py-2">Learn More
