...
const About = ({ aboutRef }) => {
    ...
    return (
        <>     
            <div ref={(node) => { ref(node); aboutRef.current = node; }} className="justify-between px-4 py-56 sm:px-64 sm:py-64 min-h-screen snap-start">
